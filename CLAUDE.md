...
| HelpCenterPanel | components/HelpCenterPanel/HelpCenterPanel.tsx | open, onClose, onStartTour?(tourId) — workflow-canvas Help center drawer (home: Video tutorials / Interactive tours / Support articles + Still need help?; nested searchable lists); trigger is `.rr-chrome-help` top-right inside AgentBuilder; Interactive tours "Start tour" reopens `WorkflowCoachTour` |
