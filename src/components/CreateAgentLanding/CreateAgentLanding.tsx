...
// Canonical "Create with AI" welcome state — avatar + greeting + quick-start
// options + composer. Shared by AgentDetailScreen's create-flow and LHSDrawer's
// "Create with AI" tab so both surfaces render (and evolve) identically.
export function CreateAgentLanding({
  ...
  return (
    <div className={`flex h-full w-full flex-col overflow-hidden pb-md ${className}`}>
      <div className="flex min-h-0 flex-1 flex-col justify-center gap-md overflow-hidden">
        <div className="flex translate-y-lg items-start justify-start gap-md">
          ...
          <div className="flex min-w-0 flex-col items-start gap-md">
            <p className="text-h3 leading-8 text-text-primary">{greeting}</p>
      ...
      <div className="flex min-h-40 shrink-0 flex-col gap-md rounded-lg border border-border-selected bg-surface px-lg py-md shadow-card focus-within:border-ai-brand">
        ...
        <textarea
          ...
          className="scrollbar-none min-h-16 w-full resize-none bg-transparent text-body text-text-primary outline-none placeholder:text-text-tertiary disabled:cursor-not-allowed"
        />
