...
function NavTab({
  ...
  return (
    ...
    >
      ...
      {item.badge && (
        <span className="mr-[14px] flex h-5 shrink-0 items-center justify-center rounded-sm bg-accent-positive px-sm text-[10px] leading-[18px] text-white opacity-0 transition-opacity duration-150 group-hover:opacity-100">
          {item.badge}
        </span>
      )}
    </button>
