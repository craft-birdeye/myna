...
const _SEED_TOOLS = [
  ...
  },
  {
    ...
    name: 'Update contact preference',
    icon: 'group',
    isBirdeye: true,
    ...
    fields: [
      {
        ...
        label: 'Email',
        prefKeys: [
          { id: 'ucp-email-feedback', label: 'Feedback' },
          { id: 'ucp-email-marketing', label: 'Marketing' },
          { id: 'ucp-email-service', label: 'Service updates' },
        ],
      },
      {
        id: 'ucp-text',
        ...
        label: 'Text',
        prefKeys: [
          { id: 'ucp-text-feedback', label: 'Feedback' },
          { id: 'ucp-text-marketing', label: 'Marketing' },
          { id: 'ucp-text-service', label: 'Service updates' },
        ],
      },
    ],
    inputs: [],
  ...
  {
    id: 'discover-competitor-keywords',
    name: 'Discover competitor keywords',
    icon: 'location_on',
    isBirdeye: true,
    ...
    fields: [
      {
        id: 'dck-competitors',
        type: 'competitorList',
        label: 'Track keywords from competitor domains',
        maxItems: 5,
        defaultValue: [
          { id: 'comp-pizzahut', name: 'Pizzahut', url: 'https://www.pizzahut.com/' },
          { id: 'comp-kfc', name: 'KFC', url: 'https://www.kfc.com/' },
          { id: 'comp-subway', name: 'Subway', url: 'www.subway.com' },
          { id: 'comp-ccd', name: 'Café Coffee Day', url: 'https://www.cafecoffeeday.com' },
        ],
      },
    ],
    inputs: [],
    ...
    fields: [
      {
        ...
        required: true,
        showInfoIcon: true,
        infoText: 'Stamp business details — address, phone, hours — onto the image before it publishes.',
        helpText: 'Customize how location details appear on your images.',
      },
      // Plain radios, so the shared field renderer owns their label + option chrome.
      {
        id: 'lm-text-style',
        type: 'radio',
        label: 'Text style',
        options: ['Brand colors', 'White text and black border', 'Black text and white border'],
        defaultValue: 'White text and black border',
      },
      {
        id: 'lm-element-size',
        type: 'radio',
  ...
  {
    id: 'discover-business-keywords',
    name: 'Discover business keywords',
    icon: 'travel_explore',
    isBirdeye: true,
    ...
    fields: [
      {
        id: 'dbk-listing-fields',
        type: 'readOnlyChips',
        label: 'Keywords from your business listing fields',
        options: ['Category', 'Country'],
      },
      {
        id: 'dbk-appearance',
        type: 'toggle',
        label: 'Seed keywords from Appearance report',
        helpText: 'Use keywords from Google Search Appearance as seed keywords',
        defaultValue: true,
      },
      {
        id: 'dbk-ranking',
        type: 'toggle',
        label: 'Seed keywords from Ranking report',
        helpText: 'Use keywords from Google Search Ranking as seed keywords',
        defaultValue: true,
      },
      {
        id: 'dbk-own-keywords',
        type: 'keywordChips',
        label: 'Add your own seed keywords',
        showInfoIcon: true,
        infoText: 'Up to five of your own keywords, on top of the ones pulled from your listing and reports.',
  ...
  },
  {
    ...
    fields: [
      {
        id: 'st-templates',
        type: 'templateMultiSelect',
        label: 'Templates',
        required: true,
        showInfoIcon: true,
        infoText: 'Please select a minimum of two templates',
      },
    ],
    inputs: [],
    outputs: [{ name: 'templateIds', type: 'array' }],
  },
  {
    // Same capability and config form as `handle-response`; a separate entry only so the
    // "Publish response" action card shows its own name in the Tool row.
    id: 'publish-response',
  ...
  },
  {
    ...
    fields: [
      ...
      { id: 'ivc-hc-context', label: 'Additional fields', type: 'tags', showInfoIcon: true, placeholder: 'Add input field...', defaultValue: ['Appointment ID', 'Patient ID', 'Provider ID', 'Diagnosis Code', 'Appointment_Type'] },
